    ...
    extend: {
      ...
      keyframes: {
        ...
        "kick-ball": {
          ...
          "65%":  { transform: "translate(13px, -21px)" },
          "100%": { transform: "translate(0, 0)" },
        },
        "kick-shadow": {
          "0%":   { transform: "scaleX(1)", opacity: "0.16" },
          "20%":  { transform: "scaleX(1)", opacity: "0.16" },
          "40%":  { transform: "scaleX(0.8)", opacity: "0.12" },
          "65%":  { transform: "scaleX(0.55)", opacity: "0.07" },
      ...
      animation: {
        ...
        "kick-leg":          "kick-leg 1.2s ease-in-out infinite",
        "kick-ball":         "kick-ball 1.2s ease-in-out infinite",
        "kick-shadow":       "kick-shadow 1.2s ease-in-out infinite",
      },
    },
  },
  plugins: [],

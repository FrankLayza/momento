    ...
    <>
      ...
      >
        ...
        >
          ...
          <svg viewBox="0 0 512 512" className="w-full h-full fill-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)]" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="relative z-10 flex items-center justify-center gap-1.5 transition-transform duration-200 group-hover:scale-105 group-hover:-translate-y-1">
          {loading ? (
            <svg className="animate-spin h-3.5 w-3.5 text-cream" fill="none" viewBox="0 0 24 24">
